      ...
      while (this->bool_reseed) {
            ...
            while ((i[0] < num_per_tier) && (bool_reseed)) {
                  ...
                  while ((i[1] < num_per_cycle) && (bool_reseed)) {
                        ...
                        int rand = 0;
                      //  msleep(10);
                        _waitcondition_reseed.wait(&mutex, (qBound(5, QTime::currentTime().second(), 59) + qBound(1, QTime::currentTime().minute(), 59)) * 0.01);
...
//                     msleep(25);
            ...
            //cur_idx = 0;
            //i[0] = 0;
            _waitcondition_reseed.wait(&mutex, (qBound(10, QTime::currentTime().minute(), 59) + qBound(10, QTime::currentTime().second(), 59) * 10));
            mutex.unlock();
         }
